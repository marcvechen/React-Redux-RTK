...
function App() {
  ...
  return (
    <div>
      <SearchInput search={search} handleSearch={memoizedCallbackInput} />
      <CounterButton count={count} handleCount={memoizedCallbackButton} />
      <ItemList search={search} list={itemList} />
    </div>
  );
}
